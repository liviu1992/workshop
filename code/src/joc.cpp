 ...
 // GLFWwindow* window = glfwCreateWindow (640, 480, "Workshop1", NULL, NULL);
  ...
  Utils::showOpengGLInfo();
	...
	*/
	...
	Sprite square(0,0, 0.2,0.2, Utils::Color::YELLOW);

	Sprite s1(0,0.6,0.2, 0.2, Utils::Color::GREEN);
	

	Sprite s2(0.8,0.6,0.3, 0.3, Utils::Color::BLUE);
